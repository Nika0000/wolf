...
|WOLF_START_HTTP_SERVER
|true
|Set to true to enable the HTTP/HTTPS server on the configured HTTP port

|WOLF_START_MDNS
|true
|Set to true to enable the mDNS service for automatic host discovery
|===
